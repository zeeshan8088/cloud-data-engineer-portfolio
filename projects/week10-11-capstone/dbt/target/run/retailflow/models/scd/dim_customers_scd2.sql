    ...
    create or replace table `intricate-ward-459513-e1`.`retailflow_silver`.`dim_customers_scd2`
      
    partition by timestamp_trunc(_valid_from, day)
    cluster by customer_id, _is_current
